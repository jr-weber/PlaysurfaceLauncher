...
SettingsXmlReaderException::SettingsXmlReaderException( const QString & message,
...
SettingsXmlReaderException::~SettingsXmlReaderException()
{
}

QString SettingsXmlReaderException::getDocErrors()
{
    return docErrors_;
}

int SettingsXmlReaderException::getLineNumber()
{
    return lineNumber_;
}

int SettingsXmlReaderException::getColNumber()
{
    return colNumber_;
}

QString SettingsXmlReaderException::getXmlFilename()
{
    return xmlFilename_;
}
