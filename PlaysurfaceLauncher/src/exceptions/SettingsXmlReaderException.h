...
*/
#ifndef EXCEPTIONS_SETTINGSXMLREADEREXCEPTION_H
#define EXCEPTIONS_SETTINGSXMLREADEREXCEPTION_H
...
namespace exceptions
{
    ...
    ***************************************************************************/
    class SettingsXmlReaderException : public exceptions::IOException
    {
        public:
            SettingsXmlReaderException( const QString & message,
                                        const QString & source,
                                        const QString & docErrors,
                                        int lineNumber,
                                        int colNumber,
                                        const QString & xmlFilename );
            virtual ~SettingsXmlReaderException();
