...
SettingsXmlWriterException::SettingsXmlWriterException( const QString & message,
...
SettingsXmlWriterException::~SettingsXmlWriterException()
{
}

QString SettingsXmlWriterException::getXmlFilename()
{
    return xmlFilename_;
}
