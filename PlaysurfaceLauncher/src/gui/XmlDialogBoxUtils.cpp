...
void XmlDialogBoxUtils::warnUser( exceptions::FileNotFoundException & e )
{
...
void XmlDialogBoxUtils::warnUser( exceptions::SettingsXmlReaderException & e )
{
    QString title( "Warning" );
    QString message( e.getMessage() +  "\n" + e.getXmlFilename() );
...
void XmlDialogBoxUtils::warnUser( exceptions::SettingsXmlWriterException & e )
{    
    QString title( "Warning" );
    QString message( e.getMessage() + "\n" + e.getXmlFilename() );
    openWarningMessageBox( title, message );
...
void XmlDialogBoxUtils::warnUser( exceptions::UnknownXmlTagException & e )
{
...
void XmlDialogBoxUtils::warnUser( exceptions::ValidatorException & e )
{
    QString title( "Warning" );
    QString message = e.getMessage() + "\n";
...
void XmlDialogBoxUtils::warnUser( std::vector<exceptions::UnknownXmlTagException> & errors )
{
...
void XmlDialogBoxUtils::warnUser( std::vector<exceptions::ValidatorException> & errors )
{
    int length = errors.size();
    QString title( "Warning" );
