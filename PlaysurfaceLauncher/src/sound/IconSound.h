...
*/
#ifndef SOUND_ICONSOUND_H
#define SOUND_ICONSOUND_H
...
namespace sound
{
    ...
    {
    public:
        static const QString SOUND_DIR,
                             DEFAULT_FILE;
        ...
        void setSound( const QString & menuName );
        void play();

    private:
        void readSoundFiles();

        QList<QSound *> sounds_;
        QStringList menuNames_;
        int currentIndex_;
    };
}
