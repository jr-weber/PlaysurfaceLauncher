...
namespace TUIO 
{
	...
	public:
		 ...
		 *
		 * @param  tobj  the TuioBlob reference associated to the addTuioBlob event
		 */
		 ...
		 *
		 * @param  tobj  the TuioBlob reference associated to the updateTuioBlob event
		 */
		 ...
		 *
		 * @param  tobj  the TuioBlob reference associated to the removeTuioBlob event
		 */
